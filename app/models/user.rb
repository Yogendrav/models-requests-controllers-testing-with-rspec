...
# before_save :prepare_password
  #attr_accessible :name, :email, :password, :po, :phone, :zipcode, :street
 ...
 before_save { |user| user.email = email.downcase }
  ...
  validates_length_of :street, :maximum => 150, :message => "it should not be exceed more than 150 words", :if => :street
